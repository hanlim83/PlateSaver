    ...
    setup() {
        ...
        onMounted(async () => {
            ...
            new google.maps.Map(mapDiv.value, {
                ...
                zoom : 15 /* how zoomed in is the map */
            })
        })

        var parameters = currPos.value.lat + currPos.value.lng
        var url = "https://www.google.com/maps/embed/v1/view?key"+ GOOGLE_MAPS_API_KEY+"&center="+parameters+"&zoom=18&maptype=satelite"
        srcnew = document.getElementById("link1").src = url

        return { currPos , mapDiv, url}
