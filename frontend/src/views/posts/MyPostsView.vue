    ...
    <div class="inner-box">
      <div class="container">
        <b-card-group columns>
          <IndivPost v-for="(post, ind) in myposts" :key="ind" :id="ind" :foodImage="post.foodImage" :timeStamp="post.timeStamp" :title="post.title" :userID="post.userID" :content="post.content" :tags="post.tags" />
        </b-card-group>
      </div>
    </div>
  </div>
