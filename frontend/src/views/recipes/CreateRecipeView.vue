                ...
                <b-row>
                  <b-col md="6">
                    <b-form-group label="Recipe Name:">
                      <b-form-input type="text" class="form-control" name="name" placeholder="e.g. Leftover Chicken Croquettes" v-model="name" />
                    </b-form-group>
                  </b-col>
                  <b-col md="6" class="order-1 order-md-3">
                    <b-form-group label="Description: ">
                      <b-form-textarea id="description" placeholder="e.g. This easy recipe using leftover chicken is amazing." rows="5" max-rows="12" v-model="description"></b-form-textarea>
                    </b-form-group>
                  </b-col>
                  <b-col md="6" class="order-2">
                    <b-form-group label="Prep Time:">
                      <b-form-input type="text" class="form-control" name="preptime" placeholder="e.g. 15 minutes" v-model="preptime" />
                    </b-form-group>
                  </b-col>
                  <b-col md="6" class="order-4">
                    <b-form-group label="Cooking Time:">
                      <b-form-input type="text" class="form-control" name="cooktime" placeholder="e.g. 20 minutes" v-model="cooktime" />
                    </b-form-group>
                  </b-col>
                  <b-col md="6" class="order-4">
                    <div class="form-group">
                      <label class="form-label">Servings: </label>
                      <b-form-input type="text" class="form-control" name="servings" placeholder="e.g. 3 pax" v-model="servings" />
                    </div>
                  </b-col>
                ...
                <b-row>
                  <b-col md="6">
                    <b-form-group label="Calories:">
                      <b-form-input type="text" class="form-control" name="calroies" placeholder="e.g. 228 kcal" v-model="nutritionDetails.calories" />
                    </b-form-group>
                  </b-col>
                  <b-col md="6">
                    <b-form-group label="Carbohydrates:">
                      <b-form-input type="text" class="form-control" name="carbs" placeholder="e.g. 22g" v-model="nutritionDetails.carbohydrates" />
                    </b-form-group>
                  </b-col>
                  <b-col md="6">
                    <b-form-group label="Fat:">
                      <b-form-input type="text" class="form-control" name="fat" placeholder="e.g. 14g" v-model="nutritionDetails.fat" />
                    </b-form-group>
                  </b-col>
                  <b-col md="6">
                    <b-form-group label="Protein:">
                      <b-form-input type="text" class="form-control" name="protein" placeholder="e.g. 10g" v-model="nutritionDetails.protein" />
                    </b-form-group>
                  </b-col>
                  <b-col md="6">
                    <b-form-group label="Sodium:">
                      <b-form-input type="text" class="form-control" name="sodium" placeholder="e.g. 368mg" v-model="nutritionDetails.sodium" />
                    </b-form-group>
                  </b-col>
                  <b-col md="6">
                    <b-form-group label="Cholesterol:">
                      <b-form-input type="text" class="form-control" name="cholestrol" placeholder="e.g. 0mg" v-model="nutritionDetails.cholestrol" />
                    </b-form-group>
                  </b-col>
                </b-row>
              </div>
    ...
    async createRecipe() {
      ...
      if (response.data.status == 200) {
        ...
        uploadBytes(newFileRef, this.files[0]).then(async () => {
          ...
          await axios.post(API_URL + 'recipe/image', data)
