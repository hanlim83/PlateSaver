<template>
    <div class="container-fluid">
      <div class="bg-info text-white row">
        <div class="col">
          <img src=@/assets/namelogo.png class="img-fluid py-3 px-3" width="150">
        </div>
      ...
      <router-view class="min-vh-100 row" />
  
      <footer class="py-2 bg-info text-center text-lg-start row">
        <div class="footer-body bg-info text-center">
  
          <div class="py-1">
            <img src=@/assets/namelogo.png class="img-fluid" width="150">
          </div>
          ...
          <div class="row text-center text-dark">
            <ul class="left-panel list-inline mb-0 p-0">
              ...
              <li class="list-inline-item">Privacy Policy</li>
              <li class="list-inline-item">Internships</li>
            </ul>
